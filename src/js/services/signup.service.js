...
export async function signUp( 
  ...
  date_of_birth_month, 
  date_of_birth_year) {
    console.log({ email, password, nickname, first_name, last_name, phone, gender_orientation, city, country, date_of_birth_day, date_of_birth_month, date_of_birth_year });
  try {

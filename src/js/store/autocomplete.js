...
async function renderCountries(arrayCountries, currentArray) {
   ...
   for (let country in arrayCountries) {
      if(country.toLowerCase().startsWith(inputCountry.value.toLowerCase()) && inputCountry.value != "") {
...
function renderCities(Cities, currentArray) {
   ...
   for (let city in Cities) {
      if(city.toLowerCase().startsWith(inputCity.value.toLowerCase()) && inputCity.value != "") {
